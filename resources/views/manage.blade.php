    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='email' required placeholder={{cbLang("user_name")}}/>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input autocomplete='off' type="password" class="form-control" name='password' required placeholder={{cbLang("password")}}/>
