<?php namespace App\Http\Controllers;
	...
	class AdminSalonClientsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:salon_clients','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:salon_clients","placeholder"=>"Please enter a valid email address"];
			# OLD END FORM
