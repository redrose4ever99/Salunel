<?php namespace App\Http\Controllers;
	...
	class AdminSalonDaysController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Day","name"=>"day","join"=>"week-days,original_name"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];                                    
			$this->form[] = ['label'=>'Day','name'=>'day','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
			...
			$day=$postdata['day'];
			$days=DB::table('salon_days')->where('day',$day)->where('salon_id',$salon->id)->first();
			if( $days!=null) {    
				CRUDBooster::redirect(CRUDBooster::adminPath(),("this day already insert work time just update"));
			}
			$start =$postdata['start_time'];
			$end =$postdata['end_time'];
			if( $start >$end) {    
				
				CRUDBooster::redirect(CRUDBooster::adminPath(),("start must be befor end be attention"));
			}
	    ...
	    */
	    public function hook_before_edit(&$postdata,$id) {        
			...
			$days=DB::table('salon_days')->where('day',$day)->where('salon_id',$salon->id)->first();
			if( $days!=null) {    
				CRUDBooster::redirect(CRUDBooster::currentPath(),("this day already insert work time just update"));
			}
			$start =$postdata['start_time'];
			$end =$postdata['end_time'];
			if( $start >$end) {    
				
				CRUDBooster::redirect(CRUDBooster::currentPath(),("start must be befor end be attention"));
			}
	    }
