<?php namespace App\Http\Controllers;
	...
	class AdminSalonServiceForSalonController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Main Price","name"=>"main_price","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Duration","name"=>"duration","type"=>"time","required"=>TRUE,"validation"=>"required|date_format:H:i:s"];
	    ...
	    */
	    public function hook_before_add(&$postdata) {      
			...
			$salon=DB::table('salons')->where('user_id',CRUDBooster::myId())->first();
			$service=DB::table('service_trans')->where('abbr',$abbr)->where('service_id',$postdata['service_id'])->first();
