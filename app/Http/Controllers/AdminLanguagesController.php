<?php namespace App\Http\Controllers;
	...
	class AdminLanguagesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "locale_name";
			$this->limit = "20";
			...
			//$this->form[] = ["label"=>"Locale Name","name"=>"locale_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Ar Name","name"=>"ar_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Direction","name"=>"direction","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
